        ...
        function($location, $anchorScroll) {
            ...
            var Validator = {
                ...
                validationMessages: {
					...
					websiteName: "Please enter a valid url",
				...
				validateWebsite: function(websiteName) {

                    if (!websiteName) return true;
					if (/^(http(?:s)?\:\/\/[a-zA-Z0-9]+(?:(?:\.|\-)[a-zA-Z0-9]+)+(?:\:\d+)?(?:\/[\w\-]+)*(?:\/?|\/\w+\.[a-zA-Z]{2,4}(?:\?[\w]+\=[\w\-]+)?)?(?:\&[\w]+\=[\w\-]+)*)$/.test(websiteName)) return true;
                    return false;
                },
